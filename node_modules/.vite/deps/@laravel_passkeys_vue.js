import { Bt as onUnmounted, It as onMounted, qn as ref } from "./vue.runtime.esm-bundler-BUqatHe7.js";
...
//#endregion
//#region node_modules/@laravel/passkeys/dist/vue.js
var w = ({ autofill: y = !1, routes: c$1, onSuccess: i, onError: o } = {}) => {
	const e = ref(!1), a = ref(null), l = ref(!1), f = ref(null), p = () => {
		...
		e.value = !0, p();
		try {
			const n = await P$1.verify({ routes: c$1 });
			i?.(n);
		} catch (n) {
			v(n);
		} finally {
	...
	return onMounted(async () => {
		if (l.value = P$1.isSupported(), !(!y || (P$1.cancel(), !await P$1.isAutofillSupported()))) {
			e.value = !0, p();
			try {
				const r = await P$1.autofill({ routes: c$1 });
				r && i?.(r);
			} catch (r) {
				v(r);
			} finally {
...
var P = ({ routes: y, onSuccess: c$2, onError: i } = {}) => {
	const o = ref(!1), e = ref(null), a = ref(!1), l = ref(null);
	return onMounted(() => {
		a.value = P$1.isSupported();
	}), {
		register: async (p) => {
...
//#endregion
export { P as usePasskeyRegister, w as usePasskeyVerify };
