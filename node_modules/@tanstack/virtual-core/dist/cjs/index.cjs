  ...
  constructor(opts) {
    ...
    this.setOptions = (opts2) => {
      ...
      if (prevOptions !== void 0 && prevOptions.enabled && merged.enabled && merged.anchorTo === "end" && this.scrollElement !== null) {
        ...
        const getPreviousKey = (index) => lazyMeasurements.getMeasurementKey(previousItems[index]);
    ...
    this._willUpdate = () => {
      ...
      if (anchor && this.scrollElement && this.options.enabled) {
        ...
        if (key !== null && !followOnAppend) {
          ...
          } else if (((_b = this.scrollState) == null ? void 0 : _b.behavior) === "smooth" && !utils.approxEqual(
    ...
    this.getMeasurements = utils.memo(
      ...
      ({
        ...
        if (lanes === 1) {
          ...
          const view = lazyMeasurements.createLazyMeasurementsView(items, flat);
