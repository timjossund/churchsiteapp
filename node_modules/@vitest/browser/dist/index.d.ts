import { TestProject, ResolvedConfig, BrowserServerFactory, BrowserCommand, BrowserProviderOption } from 'vitest/node';
...
declare function assertBrowserFileAccess(project: TestProject, path: string): void;
declare function assertBrowserApiWrite(project: TestProject, path: string): void;

//#endregion
//#region src/locatorGenerators.d.ts
/**
