 ...
 */
declare function defineConfig<T extends OxfmtConfig>(config: T & OxfmtConfig): T;
/**
...
//#endregion
export { type ArrowParensConfig, type CommentLineStrategyConfig, type CustomGroupItemConfig, type EmbeddedLanguageFormattingConfig, type EndOfLineConfig, type FormatConfig, FormatOptions, type GlobSet, type HtmlWhitespaceSensitivityConfig, type ImportModifierConfig, type ImportSelectorConfig, type JsdocConfig, type JsdocUserConfig, type LineWrappingStyleConfig, type NewlinesBetweenMarker, type ObjectWrapConfig, type OperatorPositionConfig, OxfmtConfig, type OxfmtOverrideConfig, type Oxfmtrc, type ProseWrapConfig, type QuotePropsConfig, type SortGroupItemConfig, type SortImportsConfig, SortImportsOptions, type SortImportsUserConfig, type SortOrderConfig, type SortPackageJsonConfig, SortPackageJsonOptions, type SortPackageJsonUserConfig, type SortTailwindcssConfig, SortTailwindcssOptions, type SortTailwindcssUserConfig, type SvelteConfig, type SvelteUserConfig, TailwindcssOptions, type TrailingCommaConfig, defineConfig, format, jsTextToDoc };