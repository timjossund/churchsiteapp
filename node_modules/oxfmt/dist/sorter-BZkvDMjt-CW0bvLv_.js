import { i as __require, t as __commonJSMin } from "./chunk-DSjvVL_1-BctMxWBo.js";
import { fileURLToPath, pathToFileURL } from "node:url";
import * as path from "node:path";
import { dirname, resolve } from "path";
import { readdirSync, statSync } from "fs";
import fs from "node:fs";
//#region ../../node_modules/.pnpm/prettier-plugin-tailwindcss@0.0.0-insiders.2b6f3c2_prettier-plugin-svelte@4.1.1_prettie_8e5e29e2f30c74667a51d59da2b8a3db/node_modules/prettier-plugin-tailwindcss/dist/resolve-pWjAK-4f.mjs
...
//#endregion
//#region ../../node_modules/.pnpm/prettier-plugin-tailwindcss@0.0.0-insiders.2b6f3c2_prettier-plugin-svelte@4.1.1_prettie_8e5e29e2f30c74667a51d59da2b8a3db/node_modules/prettier-plugin-tailwindcss/dist/utils-D8dQkKEd.mjs
...
//#endregion
//#region ../../node_modules/.pnpm/prettier-plugin-tailwindcss@0.0.0-insiders.2b6f3c2_prettier-plugin-svelte@4.1.1_prettie_8e5e29e2f30c74667a51d59da2b8a3db/node_modules/prettier-plugin-tailwindcss/dist/sorter-BZkvDMjt.mjs
...
async function getTailwindConfig(options) {
	...
	if (jsConfig) {
		if (!stylesheet) return pathToApiMap.remember(`${pkgDir}:${jsConfig}`, async () => {
			const { loadV3 } = await import("./v3-D-mr2VVh-DyFPrrrQ.js");
	...
	return pathToApiMap.remember(`${pkgDir}:${stylesheet}`, async () => {
		const { loadV4 } = await import("./v4-C-HWEQJm-CFEoKlzb.js");
