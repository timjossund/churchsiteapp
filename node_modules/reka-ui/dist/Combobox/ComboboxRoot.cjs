...
const require_Combobox_useComboboxContentPositioning = require('./useComboboxContentPositioning.cjs');
...
Object.defineProperty(exports, 'provideComboboxRootContext', {
  enumerable: true,
  get: function () {
    return provideComboboxRootContext;
  }
});
