...
var DateFieldRoot_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		const props = __props;
		const emits = __emit;
		const { disabled, readonly, isDateUnavailable: propsIsDateUnavailable, granularity, defaultValue, stepSnapping, dir: propDir, locale: propLocale } = (0, vue.toRefs)(props);
		...
		const inputType = (0, vue.computed)(() => require_date_utils.getInputType(inferredGranularity.value));
		const inputValue = (0, vue.computed)(() => require_date_utils.normalizeInputValue(modelValue.value, inferredGranularity.value));
		const inputMaxValue = (0, vue.computed)(() => props.maxValue ? require_date_utils.normalizeInputValue(props.maxValue, inferredGranularity.value) : void 0);
		const inputMinValue = (0, vue.computed)(() => props.minValue ? require_date_utils.normalizeInputValue(props.minValue, inferredGranularity.value) : void 0);
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_Primitive_Primitive.Primitive), (0, vue.mergeProps)(_ctx.$attrs, {
				...
				default: (0, vue.withCtx)(() => [(0, vue.renderSlot)(_ctx.$slots, "default", {
					...
					max: inputMaxValue.value,
					min: inputMinValue.value,
