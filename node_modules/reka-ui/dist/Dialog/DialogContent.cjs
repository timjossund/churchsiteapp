...
var DialogContent_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { emit: __emit }) {
		...
		const staysMounted = (0, vue.computed)(() => props.forceMount || !rootContext.unmountOnHide.value);
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_Presence_Presence.Presence_default), {
				present: (0, vue.unref)(rootContext).open.value,
				"force-mount": staysMounted.value
			}, {
				default: (0, vue.withCtx)(({ present }) => [(0, vue.unref)(rootContext).modal.value ? (0, vue.withDirectives)(((0, vue.openBlock)(), (0, vue.createBlock)(require_Dialog_DialogContentModal.DialogContentModal_default, (0, vue.mergeProps)({
					key: 0,
					...
					_: 2
				}, 1040, ["present"])), [[vue.vShow, _ctx.forceMount || (0, vue.unref)(rootContext).unmountOnHide.value || present]]) : (0, vue.withDirectives)(((0, vue.openBlock)(), (0, vue.createBlock)(require_Dialog_DialogContentNonModal.DialogContentNonModal_default, (0, vue.mergeProps)({
					key: 1,
					ref: (0, vue.unref)(forwardRef),
					present: staysMounted.value ? present : true
				}, {
					...
					default: (0, vue.withCtx)(() => [(0, vue.renderSlot)(_ctx.$slots, "default")]),
					_: 2
				}, 1040, ["present"])), [[vue.vShow, _ctx.forceMount || (0, vue.unref)(rootContext).unmountOnHide.value || present]])]),
				_: 3
