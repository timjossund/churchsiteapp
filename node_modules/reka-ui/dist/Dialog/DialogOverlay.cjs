	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return (0, vue.unref)(rootContext)?.modal.value ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_Presence_Presence.Presence_default), {
				...
				default: (0, vue.withCtx)(({ present }) => [(0, vue.withDirectives)((0, vue.createVNode)(require_Dialog_DialogOverlayImpl.DialogOverlayImpl_default, (0, vue.mergeProps)(_ctx.$attrs, {
					...
					"as-child",
					"present"
				]), [[vue.vShow, _ctx.forceMount || (0, vue.unref)(rootContext).unmountOnHide.value || present]])]),
				_: 3
			}, 8, ["present", "force-mount"])) : (0, vue.createCommentVNode)("v-if", true);
		};
	}
});
