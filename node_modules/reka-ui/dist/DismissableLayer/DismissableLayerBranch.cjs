...
var DismissableLayerBranch_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props) {
		...
		(0, vue.onMounted)(() => {
			...
			if (registeredElement) require_DismissableLayer_context.context.branches.add(registeredElement);
		});
		(0, vue.onUnmounted)(() => {
			if (registeredElement) {
				require_DismissableLayer_context.context.branches.delete(registeredElement);
