...
var DrawerContentImpl_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { emit: __emit }) {
		...
		function onMountAutoFocus(event) {
			...
			if (props.initialFocus === false) event.preventDefault();
			else if (props.initialFocus instanceof HTMLElement) {
				event.preventDefault();
				require_FocusScope_utils.focus(props.initialFocus, { select: true });
			}
		}
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_FocusScope_FocusScope.FocusScope_default), {
				...
				onMountAutoFocus,
				onUnmountAutoFocus: _cache[0] || (_cache[0] = ($event) => emits("closeAutoFocus", $event))
			}, {
