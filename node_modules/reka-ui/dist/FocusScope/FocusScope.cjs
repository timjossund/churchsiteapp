...
var FocusScope_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { emit: __emit }) {
		...
		function dispatchMountAutoFocus(container, previouslyFocusedElement) {
			...
			container.addEventListener(require_FocusScope_utils.AUTOFOCUS_ON_MOUNT, handleMountAutoFocus);
			container.dispatchEvent(mountEvent);
			container.removeEventListener(require_FocusScope_utils.AUTOFOCUS_ON_MOUNT, handleMountAutoFocus);
		...
		(0, vue.watch)(() => props.present, async (present, prevPresent) => {
			if (!__vueuse_shared.isClient) return;
