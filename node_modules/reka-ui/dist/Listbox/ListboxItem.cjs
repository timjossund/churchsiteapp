...
var ListboxItem_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { emit: __emit }) {
		...
		const isHighlighted = (0, vue.computed)(() => currentElement.value != null && currentElement.value === rootContext.highlightedElement.value);
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(CollectionItem), { value: _ctx.value }, {
				default: (0, vue.withCtx)(() => [(0, vue.withMemo)([
					isHighlighted.value,
					isSelected.value,
					disabled.value,
					(0, vue.unref)(rootContext).focusable.value,
					...Object.entries(_ctx.$attrs).flat()
				], () => (0, vue.createVNode)((0, vue.unref)(require_Primitive_Primitive.Primitive), (0, vue.mergeProps)({ id: (0, vue.unref)(id) }, _ctx.$attrs, {
					...
					onPointermove: _cache[0] || (_cache[0] = () => {
						...
						if ((0, vue.unref)(rootContext).highlightOnHover.value) (0, vue.unref)(rootContext).changeHighlight((0, vue.unref)(currentElement), false, false);
					})
				}), {
