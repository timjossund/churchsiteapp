...
const [injectListboxHighlightScrollContext, provideListboxHighlightScrollContext] = require_shared_createContext.createContext("ListboxHighlightScroll");
var ListboxRoot_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const { getItems, getItem } = require_Collection_Collection.useCollection({ isProvider: true });
		...
		provideListboxHighlightScrollContext({
			suppressHighlightScroll: (0, vue.ref)(false),
...
Object.defineProperty(exports, 'provideListboxHighlightScrollContext', {
  enumerable: true,
  get: function () {
    return provideListboxHighlightScrollContext;
  }
});
