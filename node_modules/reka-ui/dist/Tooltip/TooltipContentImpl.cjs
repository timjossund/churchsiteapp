...
var TooltipContentImpl_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { emit: __emit }) {
		...
		const popperContentProps = (0, vue.computed)(() => {
			...
			return (0, defu.defu)(restProps, providerContext.content.value ?? {}, {
				side: "top",
				sideOffset: 0,
				align: "center",
		...
		(0, vue.onMounted)(() => {
			...
			(0, __vueuse_core.useEventListener)(document, require_Tooltip_utils.TOOLTIP_OPEN, rootContext.onClose);
		});
		return (_ctx, _cache) => {
