...
const require_DismissableLayer_context = require('../DismissableLayer/context.cjs');
...
const useBodyLockStackCount = (0, __vueuse_core.createSharedComposable)(() => {
	...
	const context$1 = require_ConfigProvider_ConfigProvider.injectConfigProviderContext({ scrollBody: (0, vue.ref)(true) });
	let stopTouchMoveListener = null;
	const resetBodyStyle = () => {
		document.body.style.paddingRight = "";
		document.body.style.marginRight = "";
		if (require_DismissableLayer_context.context.layersWithOutsidePointerEventsDisabled.size === 0) document.body.style.pointerEvents = "";
	...
	(0, vue.watch)(locked, (val, oldVal) => {
		...
		const config = context$1.scrollBody?.value ? typeof context$1.scrollBody.value === "object" ? (0, defu.defu)({
